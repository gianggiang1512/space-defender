...
public class MenuGamePanel extends BaseContainer {
	...
	protected void initComponents() {
		...
		icon = new ImageIcon(getClass().getResource("/IMAGES/ABOUT.png"));
		this.aboutButtonImage = icon.getImage();
	}
	...
	protected void paintComponent(Graphics g) {
		...
		g2d.drawImage(aboutButtonImage, CommonValues.WIDTH_GUI / 2
				- CommonValues.WIDTH_BUTTON / 2, CommonValues.HEIGHT_GUI / 2
				+ 2 * (CommonValues.HEIGHT_BUTTON + 20), null);
		g2d.drawImage(exitButtonImage, CommonValues.WIDTH_GUI / 2
				- CommonValues.WIDTH_BUTTON / 2, CommonValues.HEIGHT_GUI / 2
				+ 3 * (CommonValues.HEIGHT_BUTTON + 20), null);
	}
			...
			if (mouseY >= CommonValues.HEIGHT_GUI / 2 + 2
					* (CommonValues.HEIGHT_BUTTON + 20)
					&& mouseY <= CommonValues.HEIGHT_GUI / 2 + 2
							* (CommonValues.HEIGHT_BUTTON + 20)
							+ CommonValues.HEIGHT_BUTTON) {
				JOptionPane.showMessageDialog(MenuGamePanel.this,
						"Game: Space defender"
								+ "\nMôn: Kĩ thuật đồ họa - Nhóm 01"
								+ "\nThành viên:" + "\nĐặng Trường Giang"
								+ "\nMai Văn Bình" + "\nLê Hữu Dũng"
								+ "\nNguyễn Gia Đăng", "About",
						JOptionPane.INFORMATION_MESSAGE);
			}

			// Exit
			if (mouseY >= CommonValues.HEIGHT_GUI / 2 + 3
					* (CommonValues.HEIGHT_BUTTON + 20)
					&& mouseY <= CommonValues.HEIGHT_GUI / 2 + 3
							* (CommonValues.HEIGHT_BUTTON + 20)
							+ CommonValues.HEIGHT_BUTTON) {
